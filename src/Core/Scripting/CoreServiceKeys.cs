...
namespace Ludots.Core.Scripting
{
    ...
    public static class CoreServiceKeys
    {
        ...
        public static readonly ServiceKey<TweenCommandBuffer> TweenCommandBuffer = new("TweenCommandBuffer");
        public static readonly ServiceKey<TweenInstanceBuffer> TweenInstanceBuffer = new("TweenInstanceBuffer");
        public static readonly ServiceKey<TweenSinkRegistry> TweenSinkRegistry = new("TweenSinkRegistry");
        public static readonly ServiceKey<TweenService> TweenService = new("TweenService");
        public static readonly ServiceKey<TweenedScreenOverlayRegistry> TweenedScreenOverlayRegistry = new("TweenedScreenOverlayRegistry");
