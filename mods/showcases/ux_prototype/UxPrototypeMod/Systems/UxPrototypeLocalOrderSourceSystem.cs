...
internal sealed class UxPrototypeLocalOrderSourceSystem : ISystem<float>
{
    ...
    public UxPrototypeLocalOrderSourceSystem(World world, Dictionary<string, object> globals, OrderQueue orders, IModContext context)
    {
        _world = world;
        _globals = globals;
        _context = context;
