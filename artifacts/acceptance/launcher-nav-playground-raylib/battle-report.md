...
- Adapter: `raylib`
- Launch command: `.\scripts\run-mod-launcher.cmd cli launch nav_playground --adapter raylib --record artifacts/acceptance/launcher-nav-playground-raylib`
...
## Timeline
- [T+000] 000_start | MedianX T0=-9420 T1=9420 | Crossed T0=0% T1=0% | Center=0 move=0 stop=0 | Moving=0 | Tick=5.513ms
- [T+120] 120_t120 | MedianX T0=-9398 T1=9398 | Crossed T0=0% T1=0% | Center=0 move=0 stop=0 | Moving=72 | Tick=6.020ms
- [T+240] 240_t240 | MedianX T0=-9056 T1=9056 | Crossed T0=0% T1=0% | Center=0 move=0 stop=0 | Moving=128 | Tick=1.470ms
- [T+360] 360_t360 | MedianX T0=-7942 T1=7942 | Crossed T0=0% T1=0% | Center=0 move=0 stop=0 | Moving=128 | Tick=2.085ms
- [T+480] 480_t480 | MedianX T0=-6687 T1=6687 | Crossed T0=0% T1=0% | Center=0 move=0 stop=0 | Moving=128 | Tick=1.372ms
- [T+600] 600_t600 | MedianX T0=-5450 T1=5449 | Crossed T0=0% T1=0% | Center=0 move=0 stop=0 | Moving=128 | Tick=1.497ms
- [T+720] 720_t720 | MedianX T0=-4117 T1=4115 | Crossed T0=0% T1=0% | Center=14 move=14 stop=0 | Moving=128 | Tick=1.593ms
...
- median headless tick: `1.951ms`
- max headless tick: `194.006ms`
