...
参考文档：`docs/architecture/adapter_pattern.md`
...
参考文档：`docs/architecture/mod_architecture.md`、`docs/architecture/mod_runtime_single_source_of_truth.md`
...
参考文档：`docs/architecture/adapter_pattern.md`、`docs/architecture/gas_layered_architecture.md`
...
参考实现：`docs/architecture/ecs_soa.md`
...
| Mod | `mods/<modId>/`（仓库根目录下，不在 `src/` 内） |
